...
const Login = () => {
    ...
    return (
        <div className="w-full h-screen flex justify-center items-center bg-blue-500">
            <img src='./skyscrapers.png' className="h-screen w-screen absolute z-0 brightness-50" />
            <div className="absolute h-screen w-screen bg-blue-900 z-10 opacity-50"></div>
            <div className="z-50">
